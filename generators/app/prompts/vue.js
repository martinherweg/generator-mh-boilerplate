/**
 * Prompt Question for the Vue Option
 *
...
const vuePrompts = [
  {
    ...
    message: message({
      ...
      description:
        'Choose between Standalone and Runtime only which only allows you to use Vue within .vue Files or with Render Functions!',
      defaultValue: false,
    }),
    choices: [
      {
