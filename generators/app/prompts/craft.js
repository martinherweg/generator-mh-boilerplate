/**
 * Prompt Question for the Craft Option
 *
...
const craftPrompts = [
  {
    ...
    message: message({
      ...
      description:
        'Download the Latest Craft Version (You still need to add your Database credentials and run the Installation Process)',
      defaultValue: false,
    }),
    default: true,
  },
    ...
    choices: [
      {
        name: message({
          ...
          description:
            'Please visit https://github.com/nystudio107/craft-multi-environment for further Information',
          defaultValue: false,
        }),
        value: 'nystudio',
      },
      {
        name: message({
          ...
          description:
            'Please visit https://craftcms.com/docs/requirements for further Information',
          defaultValue: false,
        }),
        value: 'default',
      },
